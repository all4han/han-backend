...
public class OauthPrincipal implements OAuth2User, UserDetails {
    ...
    public static OauthPrincipal create(User user) {
    ...
    public static OauthPrincipal create(User user, Map<String, Object> attributes) {
        OauthPrincipal oauthPrincipal = OauthPrincipal.create(user);
        oauthPrincipal.setAttributes(attributes);
