package ex.han.backend.domain.config;

import ex.han.backend.domain.config.jwt.JWtFilter;
import ex.han.backend.domain.config.jwt.JwtProvider;
import ex.han.backend.domain.config.auth.AuthFailHandler;
import ex.han.backend.domain.config.auth.AuthSuccessHandler;
...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins(frontServerUrl, "favicon.ico")
...
//                                .anyRequest().permitAll()
                ...
                .oauth2Login(oauth2 -> oauth2
                        ...
                        .successHandler(new AuthSuccessHandler(userRepository, jwtProvider, redirectUrl))
